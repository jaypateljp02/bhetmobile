...
const ProductsPage = () => {
    const { getPhoneProducts, loading } = useApp();
            ...
            <div className="pt-24 pb-12 px-4" style={{ backgroundColor: 'var(--color-secondary)' }}>
                <div className="container mx-auto max-w-6xl">
                    ...
                    <h1 className="text-4xl font-bold text-theme-text flex items-center gap-3">
                        <ShoppingBag className="text-theme-primary" />
                        All Mobile Phones
                    </h1>
            ...
            <div className="container mx-auto max-w-6xl px-4 py-12">
                {loading ? (
                    <div className="text-center py-20">
                        ...
                        <p className="mt-4 text-theme-text opacity-70">Loading products...</p>
                    </div>
                ) : phones.length === 0 ? (
                    <div className="text-center py-20 card-theme rounded-2xl">
                        <ShoppingBag size={64} className="mx-auto mb-4 text-theme-primary opacity-50" />
                        <p className="text-theme-text opacity-70">No phones available yet. Check back soon!</p>
                    </div>
                ) : (
